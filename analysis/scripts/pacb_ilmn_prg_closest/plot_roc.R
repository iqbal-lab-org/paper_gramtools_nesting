...
ggsave(file.path(argv$outdir, "ROC_curve.pdf"), width=9, height=7, plot=roc_curve)
...
ggsave(file.path(argv$outdir, "precision_recall_curve.pdf"), width=9, height=7, plot=prec_recall_curve)